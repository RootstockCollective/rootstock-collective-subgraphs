...
export function communityBanned(builder: Address, event: ethereum.Event): void {
  ...
  haltBuilder(builderEntity, event);
...
export function kycApproved(builder: Address, event: ethereum.Event): void {
  ...
  resumeBuilder(builderEntity, event);
...
export function selfResumed(builder: Address, rewardPercentage: BigInt, cooldown: BigInt, timestamp: BigInt, event: ethereum.Event): void {
  ...
  updateBackerRewardPercentage(builder, rewardPercentage, cooldown, timestamp, event);
...
function resumeBuilder(builderEntity: Builder, event: ethereum.Event): void {
...
function haltBuilder(builderEntity: Builder, event: ethereum.Event): void {
...
function updateBackerRewardPercentage(builder: Address, rewardPercentage: BigInt, cooldown: BigInt, timestamp: BigInt, event: ethereum.Event): void {
  const backerRewardPercentage = loadOrCreateBackerRewardPercentage(builder);
